...
namespace FourZeroOne.Token
{
    ...
    public interface IToken<out R> : Unsafe.IToken where R : class, ResObj
    {
        ...
        public ICeasableTask<IOption<R>> Resolve(IRuntime runtime, IOption<ResObj>[] args);
    }
    ...
    {
        public sealed override ICeasableTask<IOption<R>> Resolve(IRuntime runtime, IOption<ResObj>[] _)
        {
            return Evaluate(runtime);
        }
        protected Value() : base() { }
        protected abstract ICeasableTask<IOption<R>> Evaluate(IRuntime runtime);
    }
    public abstract record PureValue<R> : Value<R> where R : class, ResObj
    {
        protected PureValue() : base() { }
        protected sealed override ICeasableTask<IOption<R>> Evaluate(IRuntime _)
        {
            return ControlledTask.FromResult(EvaluatePure().AsSome());
        }
        ...
        where ROut : class, ResObj
    {
        ...
        public sealed override ICeasableTask<IOption<ROut>> Resolve(IRuntime runtime, IOption<ResObj>[] args)
        {
            return Evaluate(runtime, args[0].RemapAs(x => (RArg1)x));
        }

        protected abstract ICeasableTask<IOption<ROut>> Evaluate(IRuntime runtime, IOption<RArg1> in1);
        ...
        where ROut : class, ResObj
    {
        ...
        protected abstract ICeasableTask<IOption<ROut>> Evaluate(IRuntime runtime, IOption<RArg1> in1, IOption<RArg2> in2);
        ...
        where ROut : class, ResObj
    {
        ...
        protected abstract ICeasableTask<IOption<ROut>> Evaluate(IRuntime runtime, IOption<RArg1> in1, IOption<RArg2> in2, IOption<RArg3> in3);
        ...
        where ROut : class, ResObj
    {
        ...
        public sealed override ICeasableTask<IOption<ROut>> Resolve(IRuntime runtime, IOption<ResObj>[] tokens)
        {
            return Evaluate(runtime, tokens.Map(x => x.RemapAs(x => (RArg)x)));
        }

        protected abstract ICeasableTask<IOption<ROut>> Evaluate(IRuntime runtime, IEnumerable<IOption<RArg>> inputs);
        ...
        where ROut : class, ResObj
    {
        ...
        protected sealed override ICeasableTask<IOption<ROut>> Evaluate(IRuntime _, IOption<RArg1> in1)
        {
        ...
        where ROut : class, ResObj
    {
        ...
        protected sealed override ICeasableTask<IOption<ROut>> Evaluate(IRuntime _, IOption<RArg1> in1, IOption<RArg2> in2)
        {
        ...
        where ROut : class, ResObj
    {
        ...
        protected sealed override ICeasableTask<IOption<ROut>> Evaluate(IRuntime _, IOption<RArg1> in1, IOption<RArg2> in2, IOption<RArg3> in3)
        {
        ...
        where ROut : class, ResObj
    {
        ...
        protected sealed override ICeasableTask<IOption<ROut>> Evaluate(IRuntime _, IEnumerable<IOption<RArg>> inputs) => ControlledTask.FromResult(EvaluatePure(inputs.Filter(x => x.IsSome()).Map(x => x.Unwrap())).AsSome());
    }
    // ----
    #endregion
    // --------
        ...
        where RSource : class, Resolution.IStateTracked
    {
        ...
        protected sealed override ICeasableTask<IOption<RSource>> Evaluate(IRuntime runtime, IOption<RSource> in1) { return ControlledTask.FromResult(in1.RemapAs(x => GetStatePSet(runtime)[x.UUID])); }
    }
}
namespace FourZeroOne.Token.Unsafe
{
    ...
    public interface IToken
    {
        ...
        public ICeasableTask<IOption<ResObj>> ResolveUnsafe(IRuntime runtime, IOption<ResObj>[] args);
    }
